...
class AnnotationList:
    ...
    """Data formatting functions to feed formatted data to the MetaPathPredict-E function"""

  
    def __init__(self, requiredColumnsAll, requiredColumnsModel, annotations, feature_df = pd.DataFrame()): 
      self.requiredColumnsAll = requiredColumnsAll # all required columns for all models
      self.requiredColumnsModel = requiredColumnsModel # list of all required columns for the chosen model
      self.annotations = annotations
    ...
    def check_feature_columns(self):
      """Checks that all required columns are present for MetaPathPredict-E's chosen model.
    ...
    def transform_model_features(self, scaler):
      """Transforms all required columns for the specified MetaPathPredict-E model.
